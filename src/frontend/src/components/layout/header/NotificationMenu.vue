<template>
  <div class="relative" ref="dropdownRef">
    <button
      class="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition"
...
const notifications = ref([
  {
    ...
    action: 'voted for the proposal',
    project: 'Enable Multisig',
    type: 'Proposal',
    time: '5 min ago',
    status: 'online',
  },
