<template>
  <header
    class="sticky top-0 flex w-full bg-white border-gray-200 z-45 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
      <div
        ...
        <button @click="handleToggle"
          class="flex items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-45 dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 lg:border"
          :class="[
            isMobileOpen
        ...
        <button @click="toggleApplicationMenu"
          class="flex items-center justify-center w-10 h-10 text-gray-700 rounded-lg z-45 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden">
