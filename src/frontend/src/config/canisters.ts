...
// ICRC Index Canister
import {
    canisterId as icrcIndexCanisterId,
    idlFactory as icrcIndexIDL,
} from "@declarations/icrc_index";
import type { _SERVICE as _ICRC_INDEX_SERVICE } from "@declarations/icrc_index/icrc_index.did.d.ts";
...
export type CanisterType = {
    ...
    ICRC_INDEX: _ICRC_INDEX_SERVICE;
...
export const canisters: CanisterConfigs = {
    ...
    icrc_index: {
        canisterId: import.meta.env.VITE_ICRC_INDEX_CANISTER_ID,
        idl: icrcIndexIDL,
        type: {} as CanisterType["ICRC_INDEX"],
    },
...
export const canisterIds = {
    ...
    icrc_index: canisters.icrc_index.canisterId,
